                    ...
                    <div class="card-body pb-0">
                        <div class="dropdown float-right">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                ...
                                <a class="dropdown-item" href="patientparmedecin.php">Gestion des Patients</a>
                                </div>
                            </div>
                        </div>
                        <h4 class="mb-0">
...
require_once 'conn.php';
            ...
            $t=$_SESSION['username'];
                     $sql3="select count(idp) as id  from `patientboitier` where idp in (select id from patient  where  id in (select idp from   `medecinpatient` where idm in (select  `id`   from `medecin` where fullname='$t'))) ";
...
require_once 'conn.php';
			...
			$conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
            $t=$_SESSION['username'];
                     $sql3="select count(idm) as id  from `medecinpatient` where idm in (select id from medecin where fullname='$t') ";
                     $stmt1 = $conn->query($sql3);
                     $row1 = $stmt1->fetch(PDO::FETCH_ASSOC);
                     $idb1=$row1['id'];
